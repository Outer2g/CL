// $ANTLR 3.2 debian-7ubuntu3 ExprInterp.g 2016-02-23 14:11:45
...
public class ExprInterpParser extends Parser {
    ...
    // $ANTLR start "expr"
    // ExprInterp.g:20:1: expr returns [int value] : e= multExpr ( '+' e= multExpr | '-' e= multExpr )* ;
    public final int expr() throws RecognitionException {
        ...
        try {
            // ExprInterp.g:21:5: (e= multExpr ( '+' e= multExpr | '-' e= multExpr )* )
            // ExprInterp.g:21:9: e= multExpr ( '+' e= multExpr | '-' e= multExpr )*
            {
            ...
            value = e;
            // ExprInterp.g:22:9: ( '+' e= multExpr | '-' e= multExpr )*
            loop3:
            do {
                int alt3=3;
    ...
    // ExprInterp.g:27:1: multExpr returns [int value] : e= atom ( '*' e= atom )* ;
    public final int multExpr() throws RecognitionException {
        ...
        try {
            // ExprInterp.g:28:5: (e= atom ( '*' e= atom )* )
            // ExprInterp.g:28:9: e= atom ( '*' e= atom )*
            {
    ...
    // $ANTLR start "atom"
    // ExprInterp.g:31:1: atom returns [int value] : ( INT | ID );
    ...
    public static final BitSet FOLLOW_stat_in_prog23 = new BitSet(new long[]{0x0000000000000072L});
    ...
    public static final BitSet FOLLOW_8_in_stat66 = new BitSet(new long[]{0x0000000000000060L});
    ...
    public static final BitSet FOLLOW_9_in_expr131 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_multExpr_in_expr135 = new BitSet(new long[]{0x0000000000000602L});
    public static final BitSet FOLLOW_10_in_expr151 = new BitSet(new long[]{0x0000000000000060L});
    ...
    public static final BitSet FOLLOW_11_in_multExpr198 = new BitSet(new long[]{0x0000000000000060L});
